...
namespace SheepRace
{
    public partial class SheepRace : Form
    {
        ...
        {
            if (myPunters[0].Cash <= 0)//Satpreet
            {
                lblLove.Text = "Satpreet is now broke and cannot continue betting";
            ...
            if (myPunters[2].Cash <= 0)//Shelly
            {
                lblMoto.Text = "Shelly is now broke and cannot continue betting";
        ...
        {
            //Show that Satpreet is betting in the bettor label
        ...
        {
            //Show that Shelly is betting in the bettor label
        ...
        private void btnRace_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Sorry but Satpreet does not have enough cash to proceed.");
            ...
            {
                MessageBox.Show("Sorry but Shelly does not have enough cash to proceed.");
                timer1.Enabled = false;
            }
            else
            {
        ...
        public void btnLockIn_Click(object sender, EventArgs e) // Unlock the Race Button and check bet amount is not more than cash
        {
            try
            {
                ...
                {
                    MessageBox.Show("Satpreet does not have enough to proceed");
                ...
                {
                    MessageBox.Show("Shelly does not have enough to proceed");
                    btnRace.Enabled = false;
                }
                else
                {
