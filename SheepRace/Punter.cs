...
namespace SheepRace
{
    ...
    public class Satpreet : Punter // Inherit from the Punter class
    {
        public Satpreet() // Sets up the punter Satpreet
        {
            Name = "Satpreet";
            Cash = 50;
        }
    ...
    public class Shelly : Punter // Inherit from the Punter class
    {
        public Shelly() // Sets up the Punter Shelly
        {
            Name = "Shelly";
            Cash = 50;
        }
